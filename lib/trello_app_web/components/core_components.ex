defmodule TrelloAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TrelloAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TrelloAppWeb.Gettext, "errors", msg, opts)
    end
  end
